...
import {
  ...
  ShieldCheck, CheckCircle2, CreditCard, Landmark, Lock,
} from "lucide-react";
import { useLanguage } from "@/lib/i18n/LanguageProvider";
import { getPricingPagePayload, type PricingPlan } from "@/lib/api/pricing-page";
import {
  initiatePayment, type CheckoutMethod, type InitiatePaymentResponse,
    ...
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-[1fr_360px] gap-6">
        ...
        <section className="bg-white rounded-2xl border border-gray-100 overflow-hidden">
          ...
          {/* Step 2 — Moyasar inline form (after initiate) */}
          {initResp && method !== "bank_transfer" && (
            <div className="p-6">
              <p className="text-[10px] font-bold tracking-wider text-gray-400 uppercase mb-3">
